;;; manjis-appearance -- Appearance and UI settings
;;; Commentary:
...
(defun manjis/reload-theme (_args)
  "Reload theme with setting of `manjis-theme'"
  (interactive "P")
  (pcase manjis-theme
  ('vscode
  ...
  ('flucui-themes
   (use-package flucui-themes
     :config
     (flucui-themes-load-style manjis-theme-style)))
  ('srcery-theme
  ...
  ('bespoke
   (use-package bespoke-themes
     ...
     (setq bespoke-set-theme manjis-theme-style)
  ...
  ('modus-themes
   (use-package modus-themes
     ...
     (if (eq manjis-theme-style 'dark)
         (modus-themes-load-vivendi)
       (modus-themes-load-operandi))))))

(defun manjis/reload-modeline (_args)
  "Reload mode line with settings of `manjis-mode-line'."
  (interactive "P")
  (pcase manjis-mode-line
    ('smart-mode-line
    ...
    ('powerline
     (use-package powerline
       :config
       (if (eq manjis-theme 'moe-theme)
           ;; This must appear AFTER =use-package powerline=
           (powerline-moe-theme)
         (powerline-center-theme))))))

(manjis/reload-modeline ())
(manjis/reload-theme ())
...
(provide 'manjis-appearance)

;;; manjis-appearance.el ends here
