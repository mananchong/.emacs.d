;;; manjis-customize-group --- Customize group settings for Manjis
;;; Commentary:
"Customize group settings for Manjis"
;;; Code:

(defgroup manjis ()
  "Nayuki's EMAcs config."
  :tag "Manjis"
  :link '(url-link :tag "GitHub" "https://github.com/nykma/manjis")
  :prefix "manjis-"
  :group 'applications)
...
(provide 'manjis-customize-group)

;;; manjis-customize-group.el ends here
